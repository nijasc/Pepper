...
final class ActorPresets {
    ...
    static List<ActorPreset> build(Context c) {
        ...
        p.add(ActorPreset.display("🌞 Sonne", d, ActorState.sun(), null));
        p.add(ActorPreset.display("❤️ Herz", d, ActorState.heart(), null));
        p.add(ActorPreset.display("🎉 Party", d, ActorState.party(), null));
        p.add(ActorPreset.display("🌴 Ferien", d, ActorState.palm(), null));
        p.add(ActorPreset.display("Bühler-Endbild", d, ActorState.brand(), "Schöne Sommerferien!"));
        p.add(ActorPreset.display("Sauberer Hintergrund", d, ActorState.idle(), null));

        String a = c.getString(R.string.actor_group_a);
        p.add(ActorPreset.display("„GLEICH\" (blinkt)", a, ActorState.blinkBanner(), "Achtung!"));
        ...
        p.add(ActorPreset.pose("🌞 FERIENMODUS", a, ActorState.banner("FERIENMODUS"), R.raw.gesture_celebrate, "Ferienmodus aktiviert!"));
        p.add(ActorPreset.sequence("▶ Auto: 3·2·1·Feuerwerk·Ferienmodus", a, Arrays.asList(
                new ActorPreset.Step(ActorState.blinkBanner(), 1000, "Achtung!"),
        ...
        p.add(ActorPreset.pose("Winken + Sonne", cc, ActorState.sun(), R.raw.gesture_wave_hand, "Tschüss, schöne Ferien!"));
        ...
        p.add(ActorPreset.pose("Sehnsucht ❤️ (späht raus)", dd, ActorState.heart(), R.raw.pose_lean_out, null));
        ...
        p.add(ActorPreset.pose("Konfetti 🎉", dd, ActorState.confetti(), R.raw.gesture_celebrate, "Schöne Sommerferien!"));
        p.add(ActorPreset.sequence("▶ Auto: Uhr kriecht · FEIERABEND", dd, Arrays.asList(
                ...
                new ActorPreset.Step(ActorState.heart(), 900, null),
